...
if [[ $ARCH == 0 ]]; then
    ...
    if [[ $ALL == 1 ]]; then
        ...
        # AVX2
        $INTELC $X86ICCFLAGS -xCORE-AVX2 -Ofast -c $KERNEL.c
        $INTELC $X86ICCFLAGS -xCORE-AVX2 -Ofast -S $KERNEL.c -use-msasm -o $KERNEL.s.csx.icc.AVX.s
        $INTELC $KERNEL.o timing.o -lm -o a.$KERNEL.csx.icc.AVX
        # SSE
        $INTELC $X86ICCFLAGS -msse4.2 -Ofast -c $KERNEL.c
        $INTELC $X86ICCFLAGS -msse4.2 -Ofast -S $KERNEL.c -use-msasm -o $KERNEL.s.csx.icc.SSE.s
        $INTELC $KERNEL.o timing.o -lm -o a.$KERNEL.csx.icc.SSE
        # Normal
		...
		# SSE
        $GNUC $X86GCCFLAGS -march=skylake -mno-avx2 -mno-avx -Ofast -c $KERNEL.c
        $GNUC $X86GCCFLAGS -march=skylake -mno-avx2 -mno-avx -Ofast -S $KERNEL.c -o $KERNEL.s.csx.gcc.SSE.s
        $GNUC $KERNEL.o timing.o -lm -o a.$KERNEL.csx.gcc.SSE
    elif [[ $CC == i* ]]; then
        # ICC --> CC=icc/ifort
        ...
        # AVX2
        $CC $X86ICCFLAGS -xCORE-AVX2 -Ofast -c $KERNEL.c
        $CC $X86ICCFLAGS -xCORE-AVX2 -Ofast -S $KERNEL.c -use-msasm -o $KERNEL.s.csx.icc.AVX.s
        $CC $KERNEL.o timing.o -lm -o a.$KERNEL.csx.icc.AVX
        # SSE
        $CC $X86ICCFLAGS -msse4.2 -Ofast -c $KERNEL.c
        $CC $X86ICCFLAGS -msse4.2 -Ofast -S $KERNEL.c -use-msasm -o $KERNEL.s.csx.icc.SSE.s
        $CC $KERNEL.o timing.o -lm -o a.$KERNEL.csx.icc.SSE
    else
        # GCC --> CC=gcc/gfortran
		...
		# SSE
        $CC $X86GCCFLAGS -march=skylake -mno-avx2 -mno-avx -Ofast -c $KERNEL.c
        $CC $X86GCCFLAGS -march=skylake -mno-avx2 -mno-avx -Ofast -S $KERNEL.c -o $KERNEL.s.csx.gcc.SSE.s
        $CC $KERNEL.o timing.o -lm -o a.$KERNEL.csx.gcc.SSE
    fi
elif [[ $ARCH == 1 ]]; then
    # Compile for Zen 
