...
# mark_description "-qopenmp-simd -fno-alias -unroll -fno-builtin -xCORE-AVX512 -qopt-zmm-usage=high -Ofast -S -use-msasm -o tri";
# mark_description "ad.s.csx.icc.s";
	.file "triad.c"
	.text
..TXTST0:
...
..B1.10:                        # Preds ..B1.9
        ...
        xorb      %dl, %dl                                      #75.3
        movl      $20, %eax                                     #75.3
        vmovsd    .L_2il0floatpacket.5(%rip), %xmm14            #78.5
        vmovsd    .L_2il0floatpacket.3(%rip), %xmm13            #78.5
        vxorpd    %xmm12, %xmm12, %xmm12                        #78.5
        vmovsd    .L_2il0floatpacket.7(%rip), %xmm11            #78.5
        vmovsd    .L_2il0floatpacket.8(%rip), %xmm10            #78.5
        vmovsd    .L_2il0floatpacket.9(%rip), %xmm9             #78.5
        vmovsd    .L_2il0floatpacket.17(%rip), %xmm8            #78.5
        vmovsd    .L_2il0floatpacket.10(%rip), %xmm7            #78.5
        vmovsd    .L_2il0floatpacket.11(%rip), %xmm6            #78.5
        vmovsd    .L_2il0floatpacket.2(%rip), %xmm5             #78.5
        vmovups   .L_2il0floatpacket.12(%rip), %zmm4            #78.17
        vmovups   .L_2il0floatpacket.13(%rip), %zmm3            #78.5
        vmovups   .L_2il0floatpacket.14(%rip), %zmm2            #78.5
        vmovdqu   .L_2il0floatpacket.16(%rip), %ymm0            #78.5
...
..B1.22:                        # Preds ..B1.21
                                # Execution count [1.44e+01]
        vmovdqu   .L_2il0floatpacket.16(%rip), %ymm1            #78.5
        xorl      %ebx, %ebx                                    #78.5
        vmovdqu   .L_2il0floatpacket.15(%rip), %ymm3            #78.5
        vmovups   .L_2il0floatpacket.14(%rip), %zmm4            #78.5
        vmovups   .L_2il0floatpacket.13(%rip), %zmm5            #78.5
...
..B1.26:                        # Preds ..B1.25
                                # Execution count [1.44e+01]
        vmovups   .L_2il0floatpacket.14(%rip), %zmm0            #78.5
        movl      %esi, %ecx                                    #78.5
        vmovups   .L_2il0floatpacket.13(%rip), %zmm1            #78.5
...
..B1.39:                        # Preds ..B1.38
                                # Execution count [4.00e+02]
        vmovups   .L_2il0floatpacket.12(%rip), %zmm2            #78.5
        xorl      %eax, %eax                                    #78.5
        movq      2120(%rsp), %rcx                              #78.5[spill]
                                # LOE rax rcx r12 r13 r14 ebx r15d xmm0 zmm2
...
..B1.55:                        # Preds ..B1.64 ..B1.62 ..B1.54 ..B1.83
                                # Execution count [1.60e+01]: Infreq
        movslq    %ebx, %rcx                                    #78.5
        vxorpd    %xmm17, %xmm17, %xmm17                        #78.5
        imulq     %r12, %rcx                                    #78.5
        vcvtsi2sdq %rcx, %xmm17, %xmm17                         #78.5
        vmovsd    .L_2il0floatpacket.17(%rip), %xmm5            #78.5
        vxorpd    %xmm11, %xmm11, %xmm11                        #78.5
        vmovsd    2088(%rsp), %xmm1                             #78.5[spill]
        vxorpd    %xmm20, %xmm20, %xmm20                        #78.5
        vdivsd    %xmm1, %xmm5, %xmm14                          #78.5
        vmulsd    .L_2il0floatpacket.10(%rip), %xmm17, %xmm18   #78.5
        vxorpd    %xmm16, %xmm16, %xmm16                        #78.5
        vcvtsi2sd 2064(%rsp), %xmm11, %xmm11                    #78.5[spill]
        vcvtsi2sdq %r15, %xmm20, %xmm20                         #78.5
        vdivsd    %xmm18, %xmm1, %xmm19                         #78.5
        vmovsd    .L_2il0floatpacket.9(%rip), %xmm12            #78.5
        movl      $.L_2__STRING.3, %edi                         #78.5
        vmulsd    .L_2il0floatpacket.11(%rip), %xmm11, %xmm9    #78.5
        vaddsd    %xmm11, %xmm11, %xmm6                         #78.5
        vcvtsi2sd %ebx, %xmm16, %xmm16                          #78.5
        vmulsd    %xmm12, %xmm11, %xmm13                        #78.5
        vmulsd    %xmm6, %xmm12, %xmm7                          #78.5
        vmulsd    %xmm14, %xmm9, %xmm10                         #78.5
        vmulsd    %xmm14, %xmm13, %xmm15                        #78.5
        vmulsd    %xmm14, %xmm7, %xmm8                          #78.5
        vmulsd    .L_2il0floatpacket.8(%rip), %xmm11, %xmm0     #78.5
        vmulsd    %xmm16, %xmm10, %xmm4                         #78.5
        vmulsd    %xmm16, %xmm8, %xmm2                          #78.5
        vmulsd    %xmm16, %xmm15, %xmm5                         #78.5
        vmulsd    %xmm20, %xmm19, %xmm3                         #78.5
        movl      %ebx, %esi                                    #78.5
        movq      %r12, %rdx                                    #78.5
        movl      $6, %eax                                      #78.5
...
..L164:
	...
	.cfi_escape 0x10, 0x0f, 0x0e, 0x38, 0x1c, 0x0d, 0xc0, 0xff, 0xff, 0xff, 0x1a, 0x0d, 0xe0, 0xff, 0xff, 0xff, 0x22
        ...
        lea       (,%r13,8), %rbx                               #29.30
        movq      %rbx, %rsi                                    #29.7
..___tag_value_triad.174:
#       aligned_alloc(size_t, size_t)
        call      aligned_alloc                                 #29.7
..___tag_value_triad.175:
                                # LOE rax rbx r13
..B3.59:                        # Preds ..B3.1
                                # Execution count [1.00e+00]
        movq      %rax, %r14                                    #29.7
...
..B3.2:                         # Preds ..B3.59
        ...
        movl      $64, %edi                                     #30.7
        movq      %rbx, %rsi                                    #30.7
..___tag_value_triad.176:
#       aligned_alloc(size_t, size_t)
        call      aligned_alloc                                 #30.7
..___tag_value_triad.177:
                                # LOE rax rbx r13 r14
..B3.60:                        # Preds ..B3.2
                                # Execution count [1.00e+00]
        movq      %rax, %r12                                    #30.7
...
..B3.3:                         # Preds ..B3.60
        ...
        movl      $64, %edi                                     #31.7
        movq      %rbx, %rsi                                    #31.7
..___tag_value_triad.178:
#       aligned_alloc(size_t, size_t)
        call      aligned_alloc                                 #31.7
..___tag_value_triad.179:
                                # LOE rax r12 r13 r14
..B3.61:                        # Preds ..B3.3
                                # Execution count [1.00e+00]
        movq      %rax, %rbx                                    #31.7
...
..B3.11:                        # Preds ..B3.10
                                # Execution count [9.00e-01]
        vmovdqu   .L_2il0floatpacket.15(%rip), %ymm4            #34.3
        xorl      %esi, %esi                                    #34.3
        vmovdqu   .L_2il0floatpacket.16(%rip), %ymm3            #34.3
        vmovups   .L_2il0floatpacket.13(%rip), %zmm2            #35.12
        vmovups   .L_2il0floatpacket.14(%rip), %zmm1            #36.12
...
..B3.15:                        # Preds ..B3.14
        ...
        movslq    %r8d, %rcx                                    #34.3
        movl      %r8d, %esi                                    #34.3
        vmovups   .L_2il0floatpacket.13(%rip), %zmm1            #35.12
        vmovups   .L_2il0floatpacket.14(%rip), %zmm0            #36.12
...
..___tag_value_triad.180:
#       timing(double *, double *)
        call      timing                                        #42.5
..___tag_value_triad.181:
...
..B3.23:                        # Preds ..B3.22
        ...
        vmovups   %zmm2, 64(%rsp)                               #48.7[spill]
        movl      %r15d, 16(%rsp)                               #48.7[spill]
        movl      %eax, %r15d                                   #48.7
        movq      %rcx, 8(%rsp)                                 #48.7[spill]
                                # LOE rbx r12 r13 r14 r15d xmm0
..B3.24:                        # Preds ..B3.23 ..B3.33 ..B3.39
...
..B3.25:                        # Preds ..B3.24
        ...
        movq      %r14, %rdi                                    #44.20
        vzeroupper                                              #44.20
..___tag_value_triad.186:
#       dummy(double *)
        call      dummy                                         #44.20
..___tag_value_triad.187:
                                # LOE rbx r12 r13 r14 r15d
..B3.70:                        # Preds ..B3.25
                                # Execution count [6.11e+00]
        vxorpd    %xmm0, %xmm0, %xmm0                           #
                                # LOE rbx r12 r13 r14 r15d xmm0
..B3.26:                        # Preds ..B3.24 ..B3.70
                                # Execution count [2.78e+01]
        testq     %r13, %r13                                    #48.35
        jle       ..B3.33       # Prob 50%                      #48.35
                                # LOE rbx r12 r13 r14 r15d xmm0
..B3.27:                        # Preds ..B3.26
                                # Execution count [2.50e+01]
        cmpq      $8, %r13                                      #48.7
        jl        ..B3.55       # Prob 10%                      #48.7
                                # LOE rbx r12 r13 r14 r15d xmm0
..B3.28:                        # Preds ..B3.27
                                # Execution count [2.50e+01]
        movq      8(%rsp), %rsi                                 #48.7[spill]
        xorl      %ecx, %ecx                                    #48.7
        vmovups   64(%rsp), %zmm2                               #48.7[spill]
        movq      %rsi, %r8                                     #48.7
                                # LOE rcx rbx rsi r8 r12 r13 r14 r15d xmm0 zmm2
..B3.29:                        # Preds ..B3.29 ..B3.28
                                # Execution count [1.39e+02]
        vmovups   (%rbx,%rcx,8), %zmm1                          #49.31
        vfmadd213pd (%r12,%rcx,8), %zmm2, %zmm1                 #49.31
        vmovupd   %zmm1, (%r14,%rcx,8)                          #49.9
        addq      $8, %rcx                                      #48.7
        cmpq      %r8, %rcx                                     #48.7
        jb        ..B3.29       # Prob 82%                      #48.7
                                # LOE rcx rbx rsi r8 r12 r13 r14 r15d xmm0 zmm2
..B3.31:                        # Preds ..B3.29 ..B3.55
                                # Execution count [2.78e+01]
        lea       1(%rsi), %rcx                                 #48.7
        cmpq      %r13, %rcx                                    #48.7
        ja        ..B3.33       # Prob 50%                      #48.7
                                # LOE rbx rsi r12 r13 r14 r15d xmm0
..B3.32:                        # Preds ..B3.31
                                # Execution count [1.39e+02]
        movq      %r13, %rcx                                    #48.7
        subq      %rsi, %rcx                                    #48.7
        vpbroadcastq %rcx, %zmm2                                #48.7
        vmovups   (%rbx,%rsi,8), %zmm3                          #49.31
        vmovups   64(%rsp), %zmm1                               #49.31[spill]
        vpcmpgtq  .L_2il0floatpacket.18(%rip), %zmm2, %k1       #48.7
        vfmadd213pd (%r12,%rsi,8), %zmm1, %zmm3                 #49.31
        vmovupd   %zmm3, (%r14,%rsi,8){%k1}                     #49.9
                                # LOE rbx r12 r13 r14 r15d xmm0
..B3.33:                        # Preds ..B3.26 ..B3.31 ..B3.32
                                # Execution count [2.78e+01]
        incl      %r15d                                         #43.5
        cmpl      16(%rsp), %r15d                               #43.5[spill]
        jb        ..B3.24       # Prob 82%                      #43.5
                                # LOE rbx r12 r13 r14 r15d xmm0
..B3.34:                        # Preds ..B3.33
                                # Execution count [5.10e+00]: Infreq
        movl      16(%rsp), %r15d                               #[spill]
                                # LOE rbx r12 r13 r14 r15d
..B3.35:                        # Preds ..B3.38 ..B3.34
                                # Execution count [5.56e+00]: Infreq
        vzeroupper                                              #52.5
        lea       1056(%rsp), %rdi                              #52.5
        lea       1048(%rsp), %rsi                              #52.5
..___tag_value_triad.193:
#       timing(double *, double *)
        call      timing                                        #52.5
..___tag_value_triad.194:
                                # LOE rbx r12 r13 r14 r15d
..B3.36:                        # Preds ..B3.35
                                # Execution count [5.56e+00]: Infreq
        ...
        jbe       ..B3.40       # Prob 18%                      #41.30
                                # LOE rbx r12 r13 r14 r15d xmm1
..B3.37:                        # Preds ..B3.36
                                # Execution count [4.56e+00]: Infreq
        lea       1040(%rsp), %rdi                              #42.5
        lea       1048(%rsp), %rsi                              #42.5
..___tag_value_triad.195:
#       timing(double *, double *)
        call      timing                                        #42.5
..___tag_value_triad.196:
                                # LOE rbx r12 r13 r14 r15d
..B3.38:                        # Preds ..B3.37
                                # Execution count [4.56e+00]: Infreq
        xorl      %eax, %eax                                    #43.5
        testl     %r15d, %r15d                                  #43.20
        jle       ..B3.35       # Prob 10%                      #43.20
...
..B3.40:                        # Preds ..B3.36
        ...
        sarl      $1, %r15d                                     #55.3
..___tag_value_triad.199:
#       gethostname(char *, size_t)
        call      gethostname                                   #57.3
..___tag_value_triad.200:
                                # LOE rbx r12 r13 r14 r15d
..B3.41:                        # Preds ..B3.40
                                # Execution count [1.00e+00]: Infreq
        movl      $.L_2__STRING.0, %esi                         #59.12
        lea       (%rsp), %rdi                                  #59.12
..___tag_value_triad.201:
#       strcmp(const char *, const char *)
        call      strcmp                                        #59.12
..___tag_value_triad.202:
                                # LOE rbx r12 r13 r14 eax r15d
..B3.62:                        # Preds ..B3.41
                                # Execution count [1.00e+00]: Infreq
        testl     %eax, %eax                                    #59.12
...
..B3.42:                        # Preds ..B3.62
        ...
        lea       (%rsp), %rdi                                  #59.12
..___tag_value_triad.203:
#       strcmp(const char *, const char *)
        call      strcmp                                        #59.12
..___tag_value_triad.204:
                                # LOE rbx r12 r13 r14 eax r15d
..B3.63:                        # Preds ..B3.42
                                # Execution count [9.01e-01]: Infreq
        testl     %eax, %eax                                    #59.12
        je        ..B3.51       # Prob 9%                       #59.12
                                # LOE rbx r12 r13 r14 r15d
..B3.43:                        # Preds ..B3.63
                                # Execution count [8.12e-01]: Infreq
        movl      $.L_2__STRING.2, %esi                         #59.12
        lea       (%rsp), %rdi                                  #59.12
..___tag_value_triad.205:
#       strcmp(const char *, const char *)
        call      strcmp                                        #59.12
..___tag_value_triad.206:
                                # LOE rbx r12 r13 r14 eax r15d
..B3.64:                        # Preds ..B3.43
                                # Execution count [8.12e-01]: Infreq
        testl     %eax, %eax                                    #59.12
        jne       ..B3.46       # Prob 78%                      #59.12
                                # LOE rbx r12 r13 r14 r15d
..B3.44:                        # Preds ..B3.64
                                # Execution count [1.79e-01]: Infreq
        vmovsd    .L_2il0floatpacket.0(%rip), %xmm0             #59.12
        vmovsd    .L_2il0floatpacket.1(%rip), %xmm1             #59.12
..___tag_value_triad.207:
#       pow(double, double)
        call      pow                                           #59.12
..___tag_value_triad.208:
                                # LOE rbx r12 r13 r14 r15d xmm0
..B3.45:                        # Preds ..B3.44
                                # Execution count [1.79e-01]: Infreq
        ...
        movq      %rax, 1032(%rsp)                              #59.12[spill]
                                # LOE rbx r12 r13 r14 r15d
..B3.46:                        # Preds ..B3.54 ..B3.52 ..B3.45 ..B3.64
                                # Execution count [1.00e+00]: Infreq
        movslq    %r15d, %rcx                                   #60.3
        vxorpd    %xmm9, %xmm9, %xmm9                           #60.3
        imulq     %r13, %rcx                                    #60.3
        vcvtsi2sdq %rcx, %xmm9, %xmm9                           #60.3
        vmovsd    .L_2il0floatpacket.17(%rip), %xmm5            #60.3
        vxorpd    %xmm15, %xmm15, %xmm15                        #60.85
        vmovsd    1024(%rsp), %xmm1                             #60.301[spill]
        vxorpd    %xmm20, %xmm20, %xmm20                        #60.147
        vdivsd    %xmm1, %xmm5, %xmm18                          #60.301
        vmulsd    .L_2il0floatpacket.10(%rip), %xmm9, %xmm10    #60.3
        vxorpd    %xmm12, %xmm12, %xmm12                        #60.3
        vcvtsi2sdq %r13, %xmm15, %xmm15                         #60.85
        vcvtsi2sd %r15d, %xmm20, %xmm20                         #60.147
        vdivsd    %xmm10, %xmm1, %xmm11                         #60.3
        vmovsd    .L_2il0floatpacket.9(%rip), %xmm16            #60.154
        movl      $.L_2__STRING.3, %edi                         #60.3
        vmulsd    .L_2il0floatpacket.11(%rip), %xmm15, %xmm13   #60.3
        vaddsd    %xmm15, %xmm15, %xmm6                         #60.3
        vcvtsi2sdq 1032(%rsp), %xmm12, %xmm12                   #60.3[spill]
        vmulsd    %xmm16, %xmm15, %xmm17                        #60.3
        vmulsd    %xmm6, %xmm16, %xmm7                          #60.3
        vmulsd    %xmm18, %xmm13, %xmm14                        #60.3
        vmulsd    %xmm18, %xmm17, %xmm19                        #60.3
        vmulsd    %xmm18, %xmm7, %xmm8                          #60.3
        vmulsd    .L_2il0floatpacket.8(%rip), %xmm15, %xmm0     #60.3
        vmulsd    %xmm12, %xmm11, %xmm3                         #60.3
        vmulsd    %xmm20, %xmm8, %xmm2                          #60.3
        vmulsd    %xmm20, %xmm14, %xmm4                         #60.3
        vmulsd    %xmm20, %xmm19, %xmm5                         #60.3
        movl      %r15d, %esi                                   #60.3
        movq      %r13, %rdx                                    #60.3
        movl      $6, %eax                                      #60.3
..___tag_value_triad.212:
#       printf(const char *__restrict__, ...)
        call      printf                                        #60.3
..___tag_value_triad.213:
                                # LOE rbx r12 r14
..B3.47:                        # Preds ..B3.46
                                # Execution count [1.00e+00]: Infreq
        movq      %r14, %rdi                                    #62.3
..___tag_value_triad.214:
#       free(void *)
        call      free                                          #62.3
..___tag_value_triad.215:
                                # LOE rbx r12
..B3.48:                        # Preds ..B3.47
                                # Execution count [1.00e+00]: Infreq
        movq      %r12, %rdi                                    #62.12
..___tag_value_triad.216:
#       free(void *)
        call      free                                          #62.12
..___tag_value_triad.217:
                                # LOE rbx
..B3.49:                        # Preds ..B3.48
                                # Execution count [1.00e+00]: Infreq
        movq      %rbx, %rdi                                    #62.21
..___tag_value_triad.218:
#       free(void *)
        call      free                                          #62.21
..___tag_value_triad.219:
                                # LOE
..B3.50:                        # Preds ..B3.49
                                # Execution count [1.00e+00]: Infreq
        addq      $1112, %rsp                                   #63.1
...
..B3.51:                        # Preds ..B3.63
        ...
        vmovsd    .L_2il0floatpacket.0(%rip), %xmm0             #59.12
        vmovsd    .L_2il0floatpacket.1(%rip), %xmm1             #59.12
..___tag_value_triad.234:
#       pow(double, double)
        call      pow                                           #59.12
..___tag_value_triad.235:
                                # LOE rbx r12 r13 r14 r15d xmm0
..B3.52:                        # Preds ..B3.51
                                # Execution count [8.91e-02]: Infreq
        ...
        vcvttsd2si %xmm0, %rax                                  #59.12
        movq      %rax, 1032(%rsp)                              #59.12[spill]
        jmp       ..B3.46       # Prob 100%                     #59.12
                                # LOE rbx r12 r13 r14 r15d
..B3.53:                        # Preds ..B3.62
                                # Execution count [9.88e-02]: Infreq
        vmovsd    .L_2il0floatpacket.0(%rip), %xmm0             #59.12
        vmovsd    .L_2il0floatpacket.1(%rip), %xmm1             #59.12
..___tag_value_triad.237:
#       pow(double, double)
        call      pow                                           #59.12
..___tag_value_triad.238:
                                # LOE rbx r12 r13 r14 r15d xmm0
..B3.54:                        # Preds ..B3.53
                                # Execution count [9.88e-02]: Infreq
